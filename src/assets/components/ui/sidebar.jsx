...
const SidebarLink = ({ link, className, component: Component = "a", ...props }) => {
...
// Main component that combines all the pieces
const ResponsiveSidebar = ({ 
  links = [], 
  className, 
  children, 
  initialOpen = false,
  linkComponent = "a" // Allow customization of the link component
}) => {
