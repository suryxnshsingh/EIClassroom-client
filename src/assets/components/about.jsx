export default function About() {
  ...
  <div class="rounded-lg border bg-gray-100 px-4 pt-8 pb-10 shadow-xl chakra-petch-regular ">
    ...
    <h3 class="font-lg text-semibold text-center leading-6 text-gray-600">Head of Department</h3>
    <p class="text-center text-sm leading-6 text-gray-500 hover:text-gray-600"> Electronics and Instrumentation Engineering</p>
